...
Pillow is a software rendering engine built from scratch in C++. It intentionally uses no libraries or API's for graphics. Instead all calculations and algorithms are implemented from scratch. This was done for learning purposes and personal entertainment. So far the engine features:
